...
BigNumber BigNumber::operator- (const BigNumber & number)
{
    ...
    while (diff.CharactersCount > 1 && diff.Number[diff.CharactersCount - 1] == 0)
        --diff.CharactersCount;
